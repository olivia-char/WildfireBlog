...
describe('addAnyEvents', function () {
  it('allows you to add events to object at any time', function () {
    var O = function () {
      function O() {
        _classCallCheck(this, O);

        (0, _.addAnyEvents)(this);
      }
  ...
  it('does not throw if you fire an event with no listeners', function () {
    var O = function () {
      function O() {
        _classCallCheck(this, O);
